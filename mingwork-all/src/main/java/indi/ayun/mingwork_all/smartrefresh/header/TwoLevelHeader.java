package indi.ayun.mingwork_all.smartrefresh.header;
...
import indi.ayun.mingwork_all.smartrefresh.api.OnTwoLevelListener;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (refreshHeader != null) {
            ...
            if (mode == View.MeasureSpec.AT_MOST) {
                ...
                super.setMeasuredDimension(resolveSize(super.getSuggestedMinimumWidth(), widthMeasureSpec), height);
            } else {
    ...
    public TwoLevelHeader setRefreshHeader(RefreshHeader header, int width, int height) {
        ...
        if (header != null) {
            ...
            if (header.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
                thisGroup.addView(header.getView(), 0, new RelativeLayout.LayoutParams(width, height));
            } else {

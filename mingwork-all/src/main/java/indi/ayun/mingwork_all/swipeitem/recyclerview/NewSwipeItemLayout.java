...
public class NewSwipeItemLayout extends ViewGroup {
    ...
    public NewSwipeItemLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class ScrollRunnable implements Runnable{
        ...
        void startScroll(int startX,int endX){
            if(startX!=endX){
                ...
                ViewCompat.postOnAnimation(NewSwipeItemLayout.this,this);
            }
        }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener {
        private NewSwipeItemLayout captureItem;
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:{
                    ...
                    NewSwipeItemLayout pointItem = null;
                    //首先知道ev针对的是哪个item
                    View pointView = findTopChildUnder(rv,(int)x,(int)y);
                    if(pointView==null || !(pointView instanceof NewSwipeItemLayout)){
                        //可能是head view或bottom view
                        pointOther = true;
                    }else
                        pointItem = (NewSwipeItemLayout) pointView;

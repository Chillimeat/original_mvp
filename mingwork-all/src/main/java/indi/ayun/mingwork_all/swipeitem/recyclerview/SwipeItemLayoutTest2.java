...
public class SwipeItemLayoutTest2 extends ViewGroup {
    ...
    public SwipeItemLayoutTest2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    class ScrollRunnable implements Runnable{
        ...
        void startScroll(int startX,int endX){
            if(startX!=endX){
                ...
                ViewCompat.postOnAnimation(SwipeItemLayoutTest2.this,this);
            }
        }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener {
        private SwipeItemLayoutTest2 mCaptureItem;
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:{
                    ...
                    SwipeItemLayoutTest2 pointItem = null;
                    //首先知道ev针对的是哪个item
                    View pointView = findTopChildUnder(rv,(int)x,(int)y);
                    if(pointView==null || !(pointView instanceof SwipeItemLayoutTest2)){
                        //可能是head view或bottom view
                        pointOther = true;
                    }else
                        pointItem = (SwipeItemLayoutTest2) pointView;
    ...
    public static void closeAllItems(RecyclerView recyclerView){
        for(int i=0;i<recyclerView.getChildCount();i++){
            ...
            if(child instanceof SwipeItemLayoutTest2){
                SwipeItemLayoutTest2 swipeItemLayout = (SwipeItemLayoutTest2) child;

...
public class SwipeItemLayoutTest1 extends ViewGroup{
    ...
    public SwipeItemLayoutTest1(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        mState = State.RESET;
    ...
    private class ScrollRunnable implements Runnable {
        ...
        void start(int startX,int dx){
            ...
            mRunning = true;
            ViewCompat.postOnAnimation(SwipeItemLayoutTest1.this,this);
        }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
            ...
            if(action==MotionEvent.ACTION_DOWN){
                ...
                SwipeItemLayoutTest1 expandChild = null;
                SwipeItemLayoutTest1 captureChild = null;

                for(int i=0;i<mRecyclerView.getChildCount();i++){
                    SwipeItemLayoutTest1 child = (SwipeItemLayoutTest1) mRecyclerView.getChildAt(i);
                    if(child.isExpand()) {
                        hasExpand = true;
                        expandChild = child;
                    }

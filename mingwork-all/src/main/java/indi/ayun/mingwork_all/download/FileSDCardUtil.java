package indi.ayun.mingwork_all.download;
...
public class FileSDCardUtil {
    ...
    public String getPublickDiskImagePicDir() {
        return getPublickDiskFileDir(MingWork_All.getContext(), DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMoviesDir() {
        return getPublickDiskFileDir(MingWork_All.getContext(), DIRECTORY_MOVIES);
    }
    ...
    public String getPublickDiskMusicDir() {
        return getPublickDiskFileDir(MingWork_All.getContext(), DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskImagePicCacheDir() {
        return getPublickDiskCacheDir(MingWork_All.getContext(), DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMusicCacheDir() {
        return getPublickDiskCacheDir(MingWork_All.getContext(), DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskMoviesCacheDir() {
        return getPublickDiskCacheDir(MingWork_All.getContext(), DIRECTORY_MOVIES);
    }

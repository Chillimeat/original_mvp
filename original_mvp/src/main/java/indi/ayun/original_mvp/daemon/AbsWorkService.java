package indi.ayun.original_mvp.daemon;
...
import indi.ayun.original_mvp.base.BaseService;
...
public abstract class AbsWorkService extends BaseService {
        ...
        if (mFirstStarted) {
            ...
            if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.N) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2)
                    DaemonEnv.startServiceSafely(new Intent(getApplication(), WorkNotificationService.class),"0");
            }
    ...
    void startService(Intent intent, int flags, int startId) {
        ...
        if (intent!=null&& IsNothing.onAnything(intent.getStringExtra("provoke"))){
            if (intent.getStringExtra("provoke").equals("0")){
    ...
    public static class WorkNotificationService extends BaseService {

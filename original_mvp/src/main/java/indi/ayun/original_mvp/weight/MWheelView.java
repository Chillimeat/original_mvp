...
public class MWheelView extends ScrollView {
    //TODO:1. 字体，线条颜色，字体大小，滚动，自动匹配，ll布局
    ...
    private void init(Context context) {
        ...
        MLog.d(TAG, "parent: " + this.getParent());
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        tv.setPadding(dip2px(8), dip2px(12), dip2px(8), dip2px(12));
        if (0 == itemHeight) {
            itemHeight = getViewMeasuredHeight(tv);
            MLog.d( "itemHeight: " + itemHeight);
...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (viewWidth == 0) {
            ...
            MLog.d(TAG, "viewWidth: " + viewWidth);
        }

        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#DFE0E6"));

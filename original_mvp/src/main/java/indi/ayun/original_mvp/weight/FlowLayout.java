...
public class FlowLayout extends ViewGroup {
    ...
    public void setData(List<String> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            layoutParams.setMargins(8, 3, 3, 3);
            textView.setLayoutParams(layoutParams);
            textView.setTextColor(Color.parseColor("#1aa8ff"));
            textView.setPadding(8, 3,8, 3);
            textView.setBackground(getResources().getDrawable(R.drawable.fillet_background_big));
            addView(textView);
        }
    }

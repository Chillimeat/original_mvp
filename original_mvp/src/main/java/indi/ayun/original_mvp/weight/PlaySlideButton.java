package indi.ayun.original_mvp.weight;
...
public class PlaySlideButton extends View {
    ...
    //椭圆边框颜色
    private String StrokeLineColor = "#000000";
    //椭圆填充颜色
    private String StrokeSolidColor = "#000000";
    //圆形边框颜色
    private String CircleStrokeColor = "#ffffff";
    //圆形checked填充颜色
    private String CircleCheckedColor = "#ffffff";
    //圆形非checked填充颜色
    private String CircleNoCheckedColor = "#ffffff";
    ...
    public PlaySlideButton(Context context) {
        super(context);
        init(context);
    }

    public PlaySlideButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PlaySlideButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

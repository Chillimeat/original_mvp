...
import indi.ayun.original_mvp.utils.transformation.ByteConvertUtil;
import indi.ayun.original_mvp.utils.transformation.HexConvertUtil;
...
public class RSAUtils {
    ...
    public static RSAPrivateKey getRSAPrivateKey(String hexModulus, String hexPrivateExponent) {
        ...
        try {
            modulus = ByteConvertUtil.hexStringToBytes(hexModulus);
            privateExponent = ByteConvertUtil.hexStringToBytes(hexPrivateExponent);
        } catch (Exception ex) {
    ...
    public static RSAPublicKey getRSAPublicKey(String hexModulus, String hexPublicExponent) {
        ...
        try {
            modulus = ByteConvertUtil.hexStringToBytes(hexModulus);
            publicExponent = ByteConvertUtil.hexStringToBytes(hexPublicExponent);
        } catch (Exception ex) {
    ...
    public static String encryptString(PublicKey publicKey, String plaintext) {
        ...
        try {
            ...
            return new String(HexConvertUtil.bytesToHexString(en_data));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return null;
    ...
    public static String decryptString(PrivateKey privateKey, String encrypttext) {
        ...
        try {
            byte[] en_data = ByteConvertUtil.hexStringToBytes(encrypttext);

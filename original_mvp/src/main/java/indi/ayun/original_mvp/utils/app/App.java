...
public class App {
    ...
    public static String getVersionName() {
        String verName = "";
        try {
            verName = OriginalMVP.getContext().getPackageManager().getPackageInfo(OriginalMVP.getContext().getPackageName(), 0).versionName;
    ...
    public static int getVersionCode() {
        int verCode = -1;
        try {
            verCode = OriginalMVP.getContext().getPackageManager().getPackageInfo(OriginalMVP.getContext().getPackageName(), 0).versionCode;
        } catch (PackageManager.NameNotFoundException e) {
    ...
    public static String getPackageName() {
        try {
            return OriginalMVP.getContext().getPackageManager().getPackageInfo(OriginalMVP.getContext().getPackageName(), 0).packageName;
    ...
    public static void getMD5(String page) {
        try {   //BuildConfig.APPLICATION_ID   当前应用包名
            PackageInfo packageInfo = OriginalMVP.getContext().getPackageManager().getPackageInfo(page,

...
public class ChineseToPinyin {
	...
	private static ChineseToPinyin appcharacterParser = new ChineseToPinyin();
	...
	//单例对象
	public static ChineseToPinyin getAppCharacterParserInstance() {
	...
	private int getChsAscii(String chs) {
		...
		try {
			...
			e.printStackTrace();
			MLog.e("ChineseToPinyin-->>getChsAscii", e.getMessage().toString());
		}
		return asc;
	}

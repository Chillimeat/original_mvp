package indi.ayun.original_mvp.utils.app;
...
import static indi.ayun.original_mvp.utils.phone.ScreenUtils.getStatusHeight2;
...
public class SystemBarUtil {
    ...
    public static final int PURECOLOR_STATUS_BAR_ALPHA=0;
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    public static void setColorDiff(Activity activity, int color, int statusBarAlpha) {
    ...
    public static void setColorForSwipeBack(Activity activity, int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            contentView.setPadding(0, getStatusHeight2(activity), 0, 0);
            contentView.setBackgroundColor(calculateStatusColor(color, statusBarAlpha));
            setTransparentForWindow(activity);
        }
    }
    /**
     * 针对根布局是 CoordinatorLayout, 状态栏透明值
     * <p>
     * 适用于图片作为背景的界面,此时需要图片填充到状态栏
     *
     * @param activity       需要设置的activity
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, int color, int statusBarAlpha) {
        ...
        if (!(contentLayout instanceof LinearLayout) && contentLayout.getChildAt(1) != null) {
            contentLayout.getChildAt(1)
                    .setPadding(contentLayout.getPaddingLeft(), getStatusHeight2(activity) + contentLayout.getPaddingTop(),
    ...
    public static void setColorForDrawerLayoutDiff(Activity activity, DrawerLayout drawerLayout, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            // 内容布局不是 LinearLayout 时,设置padding top
            if (!(contentLayout instanceof LinearLayout) && contentLayout.getChildAt(1) != null) {
                contentLayout.getChildAt(1).setPadding(0, getStatusHeight2(activity), 0, 0);
            }
            // 设置属性
            ViewGroup drawer = (ViewGroup) drawerLayout.getChildAt(1);
            drawerLayout.setFitsSystemWindows(false);
    ...
    public static void setTranslucentForImageView(Activity activity, int statusBarAlpha, View needOffsetView) {
        ...
        if (needOffsetView != null) {
            ...
            layoutParams.setMargins(0, getStatusHeight2(activity), 0, 0);
        }
    }
...
//-------------------------------------------------------------------------------------------------------------
     ...
     * @param drawerLayout DrawerLayout
     */
    private static void setTransparentForDrawerLayout(Activity activity, DrawerLayout drawerLayout) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    private static StatusBarView createStatusBarView(Activity activity, int color){
        ...
        LinearLayout.LayoutParams params =
            new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusHeight2(activity));

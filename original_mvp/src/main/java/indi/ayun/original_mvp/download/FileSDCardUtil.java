package indi.ayun.original_mvp.download;
...
public class FileSDCardUtil {
    ...
    public String getPublickDiskImagePicDir() {
        return getPublickDiskFileDir(OriginalMVP.getContext(), DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMoviesDir() {
        return getPublickDiskFileDir(OriginalMVP.getContext(), DIRECTORY_MOVIES);
    }
    ...
    public String getPublickDiskMusicDir() {
        return getPublickDiskFileDir(OriginalMVP.getContext(), DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskImagePicCacheDir() {
        return getPublickDiskCacheDir(OriginalMVP.getContext(), DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMusicCacheDir() {
        return getPublickDiskCacheDir(OriginalMVP.getContext(), DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskMoviesCacheDir() {
        return getPublickDiskCacheDir(OriginalMVP.getContext(), DIRECTORY_MOVIES);
    }

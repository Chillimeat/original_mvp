...
public class SwipeListItemLayout extends ViewGroup {
    enum Mode{
    ...
    public SwipeListItemLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    class ScrollRunnable implements Runnable{
        ...
        void startScroll(int startX,int endX){
            if(startX!=endX){
                ...
                ViewCompat.postOnAnimation(SwipeListItemLayout.this,this);
            }
        }

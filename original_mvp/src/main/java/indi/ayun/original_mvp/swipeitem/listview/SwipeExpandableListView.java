package indi.ayun.original_mvp.swipeitem.listview;
...
import indi.ayun.original_mvp.swipeitem.listview.SwipeListItemLayout.Mode;
...
public class SwipeExpandableListView extends ExpandableListView{
    private SwipeListItemLayout mCaptureItem;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action){
            case MotionEvent.ACTION_DOWN:{
                ...
                SwipeListItemLayout pointItem = null;
                //首先知道ev针对的是哪个item
                View pointView = SwipeListItemLayout.findTopChildUnder(this,(int)x,(int)y);
                if(pointView==null || !(pointView instanceof SwipeListItemLayout))
                    pointOther = true;//可能是head view、bottom view或者其它类型的item
                else
                    pointItem = (SwipeListItemLayout) pointView;

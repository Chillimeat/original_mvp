...
import indi.ayun.original_mvp.media_box.AbsBoxingViewActivity;
...
import indi.ayun.original_mvp.rotatephoto.PhotoView;
import indi.ayun.original_mvp.rotatephoto.PhotoViewAttacher;
...
public class BoxingRawImageFragment extends BoxingBaseFragment {
    ...
    private static class BoxingCallback implements IBoxingCallback {
        ...
        public void onFail(Throwable t) {
            ...
            //MLog.d(t != null ? t.getMessage() : "load raw image error.");
            mWr.get().dismissProgressDialog();

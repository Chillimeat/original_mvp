...
import indi.ayun.original_mvp.media_box.impl.fresco.AnimatedDrawable;
import indi.ayun.original_mvp.media_box.impl.fresco.AnimatedDrawableFactory;
import indi.ayun.original_mvp.media_box.impl.fresco.CloseableAnimatedImage;
import indi.ayun.original_mvp.media_box.loader.IBoxingCallback;
...
public class BoxingFrescoLoader implements IBoxingMediaLoader {
    ...
    private Drawable createDrawableFromFetchedResult(Context context, CloseableImage image) {
        if (image instanceof CloseableStaticBitmap) {
            ...
            AnimatedDrawableFactory animatedDrawableFactory = (AnimatedDrawableFactory)Fresco.getImagePipelineFactory().getAnimatedDrawableFactory(context);

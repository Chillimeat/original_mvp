package indi.ayun.original_mvp.smartrefresh.internal;
...
import indi.ayun.original_mvp.smartrefresh.util.SmartUtil;
...
public abstract class InternalClassicsFooter<T extends InternalClassicsFooter> extends InternalAbstract implements RefreshInternal {
    ...
    public static final byte ID_LINE_LEFT = 4;

    protected ImageView mLineViewLeft;
    protected ImageView mLineViewRight;
    protected RelativeLayout mLineView;
    ...
    public InternalClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        mSpinnerStyle = SpinnerStyle.Translate;
        mLineView = new RelativeLayout(context);
        mLineViewLeft = new ImageView(context);
        mLineViewRight = new ImageView(context);
        ...
        final RelativeLayout lineView = mLineView;
        final View lineViewLeft = mLineViewLeft;
        final View lineViewRight = mLineViewRight;
        ...
        lineViewLeft.setId(ID_LINE_LEFT);
        mLineView.setBackgroundColor(0);
        ...
        //到底两根线
        LayoutParams lpLine = new LayoutParams(MATCH_PARENT, WRAP_CONTENT);
        lpLine.addRule(CENTER_VERTICAL);

        LayoutParams lpLeft = new LayoutParams(density.dip2px(50), density.dip2px(1));
        lpLeft.leftMargin = density.dip2px(60);
        lineViewLeft.setBackgroundColor(Color.rgb(173, 174, 176));
        lineView.addView(lineViewLeft, lpLeft);

        LayoutParams lpRight = new LayoutParams(density.dip2px(50), density.dip2px(1));
        lpRight.rightMargin = density.dip2px(60);
        lpRight.addRule(ALIGN_PARENT_RIGHT);
        lineViewRight.setBackgroundColor(Color.rgb(173, 174, 176));
        lineView.addView(lineViewRight, lpRight);

        thisGroup.addView(lineView, lpLine);

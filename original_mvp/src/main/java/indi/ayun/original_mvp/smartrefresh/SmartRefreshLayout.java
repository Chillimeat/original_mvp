package indi.ayun.original_mvp.smartrefresh;
...
import indi.ayun.original_mvp.smartrefresh.api.DefaultRefreshFooterCreator;
import indi.ayun.original_mvp.smartrefresh.api.DefaultRefreshHeaderCreator;
import indi.ayun.original_mvp.smartrefresh.api.DefaultRefreshInitializer;
import indi.ayun.original_mvp.smartrefresh.api.RefreshContent;
import indi.ayun.original_mvp.smartrefresh.api.RefreshFooter;
...
import indi.ayun.original_mvp.smartrefresh.api.ScrollBoundaryDecider;
import indi.ayun.original_mvp.smartrefresh.constant.DimensionStatus;
...
import indi.ayun.original_mvp.smartrefresh.impl.RefreshContentWrapper;
import indi.ayun.original_mvp.smartrefresh.impl.RefreshFooterWrapper;
import indi.ayun.original_mvp.smartrefresh.impl.RefreshHeaderWrapper;
import indi.ayun.original_mvp.smartrefresh.impl.ScrollBoundaryDeciderAdapter;
import indi.ayun.original_mvp.smartrefresh.listener.OnLoadMoreListener;
import indi.ayun.original_mvp.smartrefresh.listener.OnMultiPurposeListener;
import indi.ayun.original_mvp.smartrefresh.listener.OnRefreshListener;
import indi.ayun.original_mvp.smartrefresh.listener.OnRefreshLoadMoreListener;
import indi.ayun.original_mvp.smartrefresh.listener.OnStateChangedListener;
import indi.ayun.original_mvp.smartrefresh.listener.SimpleMultiPurposeListener;
import indi.ayun.original_mvp.smartrefresh.util.DelayedRunnable;
import indi.ayun.original_mvp.smartrefresh.util.DensityUtil;
import indi.ayun.original_mvp.smartrefresh.util.ViscousFluidInterpolator;
...
import static indi.ayun.original_mvp.smartrefresh.util.DensityUtil.dp2px;
import static indi.ayun.original_mvp.smartrefresh.util.SmartUtil.fling;
import static indi.ayun.original_mvp.smartrefresh.util.SmartUtil.getColor;
import static indi.ayun.original_mvp.smartrefresh.util.SmartUtil.isContentView;
...
//            }
            ...
            if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                ...
                final float maxDragHeight = mFooterMaxDragRate < 10 ? mFooterHeight * mFooterMaxDragRate : mFooterMaxDragRate;
                mOnMultiPurposeListener.onFooterStartAnimator((RefreshFooter) mRefreshFooter, mFooterHeight, (int) maxDragHeight);
            }
        }
    }
